...
import { GridStyle } from "./GalleryGridStyle.styled";
const poodles = [
  { title: "poodle1", src: "/images/poodle1.jpg" },
  { title: "poodle3", src: "/images/poodle3.jpg" },
  { title: "poodle", src: "/images/poodle.jpg" },
  { title: "poodle2", src: "/images/poodle2.jpg" },
  { title: "poodle4", src: "/images/poodle4.jpg" },
];
const GalleryGrid = () => {
  ...
  return (
    ...
    <div className='container'>
      ...
      <div className='viewAllImg' onClick={navigateToGallery}>
        <svg
