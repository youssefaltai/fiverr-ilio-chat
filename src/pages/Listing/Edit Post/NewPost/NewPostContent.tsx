...
import UploadedImage from "../../../HomePage/components/UploadedImage/UploadedImage";
...
import { addPost, editForm, newForm } from "~/features/newpost.slice";
      ...
      <div>
        <form onSubmit={handleSubmit}   >
          <div className="content">
           ...
           <div onClick={close }><DarkButton title="Save" onClick={()=>dispatch(editForm({ index:index, editform:post}))} /></div>
